...
const WEEKS = [
  {
    number: 1,
    title: "To Be",
    focus: "Estruturas afirmativas, negativas e interrogativas com To Be",

    pdfs: [
      { label: "Conteúdo", url: "https://drive.google.com/file/d/1j1jyvwK8V8HDXmHUJe8ZtHrA1mXPsIxg/view?usp=drivesdk" }
    ],

    exercises: [
      "Leia o pdf para revisão",
      "Escreva 3 frases apresentando você em inglês no seu caderno",
      "Apresentação no AA para a próxima aula"
    ],
